            ...
            <div class="ls-sidebar-inner" id="menu">
              ...
              <nav class="ls-menu" style="overflow: hidden">
                <ul style="overflow: hidden">
                      ...
                      <li class="altmenu"><a href="agendamentos-adm.php" class="linkmenu ls-ico-edit-admin" >Agendamentos</a></li>      
