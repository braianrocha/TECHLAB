                    ...
                    <div class="ls-modal" id="modalSmall">
                        <div class="ls-modal-small">
                            ...
                            <div class="ls-modal-footer">
                                <button class="ls-btn-primary ls-ico-close ls-float-right" data-dismiss="modal">Cancelar</button>
                                <button type="submit" class="ls-btn-primary ls-ico-checkmark" onclick="preSubmit()">Salvar</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class='ls-modal-small'>
          ...
          <div class='ls-modal-footer'>
            <div id='botoes-edicao'>
              ...
              <button class='ls-btn-primary ls-ico-remove'>Excluir</button>
              <button class='ls-btn-primary ls-ico-close' data-dismiss='modal'>Cancelar</button>             
            </div>
          </div>
        </div>
      </div>
