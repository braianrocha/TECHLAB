...
<body class="documentacao documentacao_exemplos documentacao_exemplos_painel1 documentacao_exemplos_painel1_pre-painel documentacao_exemplos_painel1_pre-painel_index">
  ...
  <div class="container-fluid"> 
     ...
     <div class="ls-modal" id="modalSmall">
              ...
              <form id="" action="" class="ls-form row">
                  <fieldset>
                    <label class="ls-label col-md-12 col-xs-12">
                      ...
                      <input type="text" name="nome" placeholder="Digite seu nome" class="ls-field" required>
                    </label>
                    <label class="ls-label col-md-12 col-xs-12">
                      <b class="ls-label-text">E-mail*</b>
                        <input type="text" name="nome" placeholder="Digite seu e-mail" class="ls-field" required>    </label>       
                  </fieldset>
                  
                  <fieldset>
                      <label class="ls-label col-md-12 col-xs-12">
                        <b class="ls-label-text">CPF*</b>
                        <input type="text" name="nome" placeholder="000.000.000-00" class="ls-field ls-mask-cpf" required>
                      </label>
                      ...
                      <fieldset>
                        ...
                        <label class="ls-label col-md-12">
                         ...
                         <div class="ls-prefix-group">
                           <input type="password"  id="password_field2" name="password" value="" >
      ...
      <div class="ls-modal" id="modaledicao">
        <div class="ls-modal-small">
          <div class="ls-modal-header">
           ...
           <table class="ls-table ls-table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Manhã</td>
                  <td>Professor</td>
                  <td><button id="lapis" data-ls-module="modal" data-target="#modaledicao" type="button" class="ls-btn ls-ico-pencil"></button></td>
                </tr>
                <tr>
                    <td>Aloísio</td>
                    <td>aloisio@1213</td>
